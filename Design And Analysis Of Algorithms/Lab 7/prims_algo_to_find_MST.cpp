...
{ 
	...
	{                                                  // find unvisited nearestVertex                                                                                       
	   ...
	   for(int j=0; j<nV; j++)                         // making minVertex as parent of unvisited neighbour Vertices if it Is Nearest To them  
...
{ 
    ...
    cout<<"Time taken: "<< 1065 <<" microseconds"<<endl;
    cout<<"Machine constant: "<< 18.4985 <<"\n\n\n";
}
